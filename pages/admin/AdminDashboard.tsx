  ...
  const LiveMap = () => (
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden h-[600px] relative bg-slate-100">
           ...
           <div className="absolute top-4 right-4 bg-white p-4 rounded-lg shadow-lg">
               ...
               <div className="flex items-center text-xs mb-1"><div className="w-2 h-2 bg-green-500 rounded-full mr-2"></div> Active Driver</div>
               <div className="flex items-center text-xs"><div className="w-2 h-2 bg-gray-400 rounded-full mr-2"></div> Offline</div>
           </div>
      </div>
  );
      ...
      <div className="w-64 bg-slate-900 text-white flex flex-col">
        ...
        <nav className="flex-grow p-4 space-y-2">
            ...
            <button className="w-full flex items-center p-3 rounded-lg hover:bg-gray-800 transition-colors">
                <Users size={20} className="mr-3" /> Riders
            </button>
            <button className="w-full flex items-center p-3 rounded-lg hover:bg-gray-800 transition-colors">
                <DollarSign size={20} className="mr-3" /> Finance
            </button>
        </nav>
        ...
        <div className="p-8">
                ...
                <>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            ...
                            <p className="text-green-600 text-sm font-medium flex items-center">↑ 12.5% <span className="text-gray-400 ml-1">vs last month</span></p>
                        </div>
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                             <div className="flex justify-between items-start mb-4">
                                <div>
                             ...
                             <p className="text-blue-600 text-sm font-medium flex items-center">↑ 5.2% <span className="text-gray-400 ml-1">currently active</span></p>
                        </div>
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                             <div className="flex justify-between items-start mb-4">
                                <div>
                             ...
                             <p className="text-orange-600 text-sm font-medium flex items-center">Requires Action</p>
                        </div>
                    </div>
            ...
            {activeTab === 'drivers' && (
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div className="p-6 border-t border-b bg-gray-50 mt-8 flex justify-between items-center">
                         <h3 className="font-bold text-lg">Active Fleet</h3>
